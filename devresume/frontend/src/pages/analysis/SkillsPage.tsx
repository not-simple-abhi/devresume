      ...
      <div className="grid lg:grid-cols-2 gap-5">
        ...
        <Card>
          <div className="flex items-center gap-2 mb-4 pb-3 border-b border-gray-100">
            ...
            <h3 className="text-base font-semibold text-gray-800">Missing Skills</h3>
          ...
          {missingSkills.length > 0 ? (
              ...
              {missingSkills.map((s, i) => (
                <div key={i} className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    {s.reason && (
                      <p className="text-sm font-medium text-gray-600 mt-0.5 leading-relaxed">{s.reason}</p>
                    )}
                  </div>
                </div>
              ))}
            ...
            <p className="text-sm font-medium text-gray-400 py-4 text-center">No critical skills missing!</p>
          )}
        </Card>
        ...
        <Card>
          ...
          {quickWins.length > 0 ? (
            ...
            <p className="text-sm font-medium text-gray-400 py-4 text-center">No quick wins identified.</p>
          )}
        </Card>
        ...
        <Card className="lg:col-span-2">
          <div className="flex items-center gap-2 mb-4 pb-3 border-b border-gray-100">
            ...
            <h3 className="text-base font-semibold text-gray-800">Learning Roadmap</h3>
          </div>
            ...
            <ol className="space-y-3.5">
              {learningRoadmap.map((step, i) => (
                <li key={i} className="flex gap-4 items-start">
                  ...
                  <p className="text-sm font-medium text-gray-700 pb-1 leading-relaxed">{step}</p>
                </li>
              ))}
            </ol>
          ) : (
            <p className="text-sm font-medium text-gray-400 py-4 text-center">No roadmap generated.</p>
          )}
        </Card>
        ...
        {longTermGoals.length > 0 && (
          <Card className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4 pb-3 border-b border-gray-100">
              ...
              <h3 className="text-base font-semibold text-gray-800">Long-Term Goals</h3>
            </div>
            <ul className="space-y-3">
          ...
          <Card className="lg:col-span-2">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {Object.entries(skillCategories).map(([cat, items]) => (
                <div key={cat}>
                  <p className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-2.5 capitalize">
                    {cat.replace(/_/g, ' ')}
                  </p>
