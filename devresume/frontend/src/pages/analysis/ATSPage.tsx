      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="inline-flex items-center gap-1 text-xs px-2 py-0.5 bg-emerald-50 dark:bg-emerald-950 text-emerald-600 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800 rounded-full font-semibold">
              <CheckCircle2 size={11} /> Parsed
            </span>
          </div>
          <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Target Role: Senior Frontend Engineer</p>
        </div>
        ...
        <div className="flex gap-3">
          <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl px-4 py-2.5 text-center shadow-sm">
            <p className="text-xs font-bold uppercase tracking-widest text-gray-400 dark:text-gray-500 mb-0.5">Total Score</p>
            <p className="text-xl font-bold font-mono-data text-gray-900 dark:text-white">
              {det.overall}<span className="text-sm font-normal text-gray-400 dark:text-gray-500">/100</span>
            </p>
          </div>
          <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl px-4 py-2.5 text-center shadow-sm">
      ...
      <div className="grid lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-1 space-y-4">
          <Card className="flex flex-col items-center py-8 gap-4">
            <h3 className="text-base font-semibold text-gray-800 dark:text-gray-200 w-full text-center">ATS Parsability</h3>
            <ScoreRing score={atsScore} size="lg" />
            <p className="text-sm text-gray-600 dark:text-gray-400 text-center leading-relaxed px-2">
              {ats.scoreExplanation || 'Your resume format is readable by most Applicant Tracking Systems, but lacks specific keyword optimization.'}
            </p>
          </Card>
          ...
          <Card>
            ...
            <div className="grid grid-cols-2 gap-3 text-center">
              ...
              <div>
                <p className="text-base font-bold font-mono-data text-gray-800 dark:text-gray-200">{softSkills}%</p>
        ...
        <Card className="lg:col-span-1">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-base font-semibold text-gray-800 dark:text-gray-200">Missing Keywords</h3>
            </div>
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {missing.slice(0, 12).map((kw) => (
              <span
                key={kw}
                className="inline-flex items-center px-2.5 py-1 text-sm font-medium bg-red-50 dark:bg-red-950/60 border border-red-200 dark:border-red-900 text-red-600 dark:text-red-400 rounded-lg hover:bg-red-100 dark:hover:bg-red-950 cursor-pointer transition-colors"
              >
                {kw}
              </span>
            ))}
      ...
      <Card className="border-violet-100 dark:border-violet-900">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              <h3 className="text-base font-semibold text-gray-900 dark:text-gray-100">AI ATS Explanation</h3>
              ...
              <div className="grid sm:grid-cols-2 gap-4 mb-5">
                {ats.issues.slice(0, 4).map((issue, i) => (
                  <div key={i} className="flex items-start gap-2 text-sm text-gray-700 dark:text-gray-300">
                    <span className="text-gray-300 dark:text-gray-600 font-bold shrink-0 mt-0.5">❝</span>
            ...
            <div className="flex gap-3 pt-2 border-t border-gray-50 dark:border-gray-800">
              <Button variant="primary" size="sm" icon={<Wand2 size={13} />}>Auto-Fix Resume</Button>
              <Button variant="secondary" size="sm" icon={<Eye size={13} />}>View Details</Button>
            </div>
          </div>
        </div>
      </Card>
