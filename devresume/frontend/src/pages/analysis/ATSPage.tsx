      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="inline-flex items-center gap-1 text-xs px-2 py-0.5 bg-emerald-50 text-emerald-600 border border-emerald-200 rounded-full font-semibold">
              <CheckCircle2 size={11} /> Parsed
            </span>
          </div>
          <p className="text-sm font-medium text-gray-500">Target Role: Senior Frontend Engineer</p>
        </div>

        {/* Score badges */}
        <div className="flex gap-3">
          <div className="bg-white border border-gray-100 rounded-xl px-4 py-2.5 text-center shadow-sm">
            <p className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-0.5">Total Score</p>
          ...
          <div className="bg-white border border-gray-100 rounded-xl px-4 py-2.5 text-center shadow-sm">
            <p className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-0.5">ATS Match</p>
      ...
      <div className="grid lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-1 space-y-4">
          <Card className="flex flex-col items-center py-8 gap-4">
            <h3 className="text-base font-semibold text-gray-800 w-full text-center">ATS Parsability</h3>
          ...
          <Card>
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-base font-semibold text-gray-800">Keyword Coverage</h3>
              <span className="text-sm font-mono-data font-bold text-violet-600">
            ...
            <div className="grid grid-cols-2 gap-3 text-center">
              <div>
                <p className="text-base font-bold font-mono-data text-gray-800">{hardSkills}%</p>
                <p className="text-xs font-medium text-gray-500">Hard Skills</p>
              </div>
              <div>
                <p className="text-base font-bold font-mono-data text-gray-800">{softSkills}%</p>
                <p className="text-xs font-medium text-gray-500">Soft Skills</p>
              </div>
            </div>
          </Card>
        </div>
        ...
        <Card className="lg:col-span-1">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-base font-semibold text-gray-800">Matched Keywords</h3>
            </div>
          ...
          <div className="flex flex-wrap gap-2">
            {matched.slice(0, 20).map((kw) => (
              <span
                key={kw}
                className="inline-flex items-center px-2.5 py-1 text-sm font-medium bg-white border border-gray-200 text-gray-700 rounded-lg hover:border-violet-200 transition-colors"
              >
                {kw}
              </span>
            ))}
            {matched.length > 20 && (
              <span className="text-sm font-medium text-gray-400 self-center">+{matched.length - 20} more</span>
            )}
          </div>
        </Card>
        ...
        <Card className="lg:col-span-1">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-base font-semibold text-gray-800">Missing Keywords</h3>
            </div>
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {missing.slice(0, 12).map((kw) => (
              <span
                key={kw}
                className="inline-flex items-center px-2.5 py-1 text-sm font-medium bg-red-50 border border-red-200 text-red-600 rounded-lg hover:bg-red-100 cursor-pointer transition-colors"
      ...
      <Card className="border-violet-100">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              <h3 className="text-base font-semibold text-gray-900">AI ATS Explanation</h3>
