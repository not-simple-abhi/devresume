      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-start gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <p className="text-sm font-semibold text-gray-800 truncate">{review.resumeName}</p>
        ...
        <button
          ...
          className="opacity-0 group-hover:opacity-100 transition-opacity p-1.5 rounded-lg text-gray-400 hover:text-red-400 hover:bg-red-50"
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-bold font-mono-data text-gray-800">
              {review.overallScore}
            </span>
            <Badge
              size="sm"
              className={scoreLabelColor(review.overallScore)}
            >
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
        ...
        <div className="flex gap-2">
          {reviews.length >= 2 && (
            <Link to="/compare">
              <Button variant="secondary" size="sm" icon={<GitCompare size={13} />}>
                Compare
              </Button>
            </Link>
          )}
